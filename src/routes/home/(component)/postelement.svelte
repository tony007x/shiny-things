        ...
        <div class="flex flex-col items-end justify-between">
            ...
            <Sheet.Root open={sheetOpen}>
              <Sheet.Trigger asChild let:builder>
                <Button builders={[builder]} variant="link"
                  ><Settings color="white" class="hover:stroke-gray-300" />
                </Button>
              </Sheet.Trigger>
              <Sheet.Content side="right">
                ...
                <div class="flex flex-col gap-2 mt-4">
                  <div class="flex flex-col gap-2">
                    <Label class="font-bold">Descriptions</Label>
                    <Textarea
          ...
          <Drawer.Root open={DrawerOpen}>
            ...
            >
              ...
              >
                <Drawer.Header>
                  <Drawer.Title class="flex w-full justify-center">
                    {data.title}
                  </Drawer.Title>
                  <Drawer.Description class="flex w-full justify-center">
                    {data.content}
                  </Drawer.Description>
                ...
                <Drawer.Footer class="flex justify-end space-x-4">
                  <Button
                    on:click={() => applyoffer(data.id, data.post_type_name)}
                  >
                    {#if data.post_type_name == "seeker"}
                      OFFER
                    {:else}
